...
__global__ void calculateABOffLattice(const int dimension, const int protein_length, const float * __restrict__ p_simplex, float * p_objective_function){
...
__global__ void calculateSquare(const int dimension, const float * __restrict__ p_simplex, float * p_objective_function, bool is_specific_block = false, int specific_block = 0){
...
__global__ void calculateAbsoluteSum(const int dimension, const float * __restrict__ p_simplex, float * p_objective_function, bool is_specific_block = false, int specific_block = 0){
